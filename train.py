...
def extend_cfg(cfg):
    ...
    # Config for UnifiedNP
    cfg.TRAINER.UNIFIEDNP = CN()
    cfg.TRAINER.UNIFIEDNP.N_CTX = 16  # number of context vectors
    cfg.TRAINER.UNIFIEDNP.CTX_INIT = ""  # initialization words
    cfg.TRAINER.UNIFIEDNP.PREC = "fp16"  # fp16, fp32, amp
    ...
    cfg.triplet_loss = args.triplet_loss
    cfg.origin_clip = args.origin_clip
...
if __name__ == "__main__":
    ...
    parser.add_argument("--triplet-loss", action="store_true", help="add triplet loss")
    parser.add_argument("--origin-clip", action="store_true", help="use origin-clip")
    parser.add_argument("--random-init", action="store_true", help="random init soft labels")
    parser.add_argument(
        "--model-dir",
        type=str,
        default="",
